...
| U-B4 | 「即時錄音」開發中→disabled/明確標示 | P1 | ⬜ | DashboardView.tsx |
| U-B5 | transcribed 情境逐字稿預設展開 | P1 | ✅ | DetailView.tsx |
| U-D2 | pending 詳情 `Status: QUEUED`→中文 | P1 | ✅ | DetailView.tsx |
| U-B2 | 上傳進行中可取消 | P1 | ⬜ | useUploadQueue.ts, UploadTray.tsx |
| U-C1/U-C3 | 檔案大小上限 + 格式不符前端提示 | P1 | ✅ | page.tsx |
| U-C5 | 轉錄 task 觸發失敗顯示 toast+重試 | P1 | ✅ | useUploadQueue.ts |
| U-B3/U-D1 | 收斂雙上傳系統 / 狀態三重疊 | P1 | ⬜ | page.tsx |
| U-E3 | 刪除語意矛盾統一 | P1 | ⬜ | page.tsx |
| U-A5/U-A6/U-E4 | 假進度/ETA 改善或標示 | P1 | ⬜ | MeetingCard.tsx |
| U-C6 | SecurityWrapper MutationObserver 誤判放寬 | P1 | ⬜ | SecurityWrapper.tsx |
